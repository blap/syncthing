...
func TestCompleteConnectionManagementSystem(t *testing.T) {
	...
	t.Run("ConnectionTrackerWithMultipath", func(t *testing.T) {
		...
		tracker.accountAddedConnection(conn1, hello, 0)
		tracker.accountAddedConnection(conn2, hello, 0)
		tracker.accountAddedConnection(conn3, hello, 0)
		...
		tracker.accountRemovedConnection(conn1)
