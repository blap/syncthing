...
// TestAdaptiveMonitoringIntervals tests that monitoring intervals adapt based on connection activity
...
// TestActivityDetection tests that connection activity is properly detected
...
// TestMonitoringStateTransitions tests state transitions in monitoring
...
// TestResourceUsageImprovements tests that lazy monitoring reduces resource usage
